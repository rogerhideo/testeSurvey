    ...
    <div class="flex-grow">
      	<div class="flex-wrap">
    		 <div class="flex p-2">		   
				...
				<div class="md:flex-grow-0 h-full  bg-white shadow-md rounded-md border-gray-200 hover:shadow-xl w-min-2xl  border-l-3 focus:border-blue-500 p-5 ml-3" v-if="isOpenOptions" > 
					<div class="flex ">				
						<i
				...
				<div v-if="realValue.options.length > 0" class="w-auto bg-white shadow-md rounded-md border-gray-200 hover:shadow-xl w-min-2xl p-5  ml-3"> 
					...
					<multiplaEscolha v-if="realValue.tipoSurvey === 3" v-model="realValue.options" :displayON="true"/>
					<respostaLonga v-if="realValue.tipoSurvey === 2" v-model="realValue.options"  :displayON="true"/>
					<respostaCurta v-if="realValue.tipoSurvey === 1" v-model="realValue.options" :displayON="true"/>
				</div>
    		</div>
    	</div>  
    </div>
