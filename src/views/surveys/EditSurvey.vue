<template>
 	<div class="items-center justify-center min-h-screen bg-indigo-100 p-12 lg:p-24 xl:p-48">
		...
		<div class="md:flex-wrap w-4/5 bg-white shadow-md rounded-md border-gray-200 hover:shadow-xl w-min-2xl p-5 mt-5 border-l-3 focus:border-blue-500"> 
        	<div class="md:flex md:justify-between md:items-center w-full text-left "> 
				<input 
					type="text" 
					name="description" 
					id="description" 
					placeholder= "Digite a pergunta aqui "
					class="flex w-2/4 outline-none mt-1  p-1 mb-3  bg-gray-100 border-b-2 border-black    shadow-sm sm:text-sm  focus:border-blue-500  rounded-md"
				> 
				<div >
